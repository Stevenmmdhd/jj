        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ لتنصيب بوت ›", url=f"https://t.me/B8BIBB"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""Programmer [EITHON](https://t.me/B8BIBB) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("℡ ᯓ Music DarKet - ميوزك داركت", url=f"https://t.me/B8BIBB"),
            ],
            [
                InlineKeyboardButton(
                    "-ستيفن .", url=f"https://t.me/Q0OO0"
                ),
            ],
            [
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓌹℡ ᯓ Music DarKet - ميوزك داركت", url=f"https://t.me/B8BIBB"),
            ],
            [
                InlineKeyboardButton(
